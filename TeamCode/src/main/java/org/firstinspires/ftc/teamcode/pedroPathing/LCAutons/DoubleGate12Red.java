...
@Autonomous
@Configurable
public class DoubleGate12Red extends NextFTCOpMode {
    public DoubleGate12Red() {
        addComponents(
    ...
    public void paths() {
        ...
        Gate = PedroComponent.follower()
                .pathBuilder().addPath(
                        new BezierCurve(
                                new Pose(127.427, 56.939),
                                new Pose(109.567, 65.509),
                                new Pose(126.982, 65.509)
                        )
                ).setConstantHeadingInterpolation(Math.toRadians(0))
